 ...
 */
function ruhi_form_system_theme_settings_alter(&$form, &$form_state) {
  $theme_path = drupal_get_path('theme', 'ruhi');
  $image_folder = $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'ruhi') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
  $ruhipro = '<img src="' . $image_folder . 'ruhipro.png" />';
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thank you for using Ruhi Theme</h3>Ruhi is a free Drupal 8, 9 theme designed and developed by <a href="https://www.drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'ruhi',
  ];
  $form['layout'] = [
    '#type'  => 'details',
